/*
1- Se dispone de la clase Persona (en la carpeta tema2). Un objeto persona puede crearse sin valores iniciales o enviando en el mensaje de creación el nombre, DNI y edad (en ese orden). 
...
public class Ejercicio1P2_AF {
   ...
   public static void main(String[] args) {
      ...
      System.out.print("Ingrese un Nro. de DNI: ");
