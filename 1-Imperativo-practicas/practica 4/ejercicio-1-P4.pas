  ...
  begin
    if (a = nil) then 
      ...
      if(a^.dato.codigo > codigo1) and (a^.dato.codigo < codigo2) then 
        ObtenerMontoTotalEntreDosCodigos := ObtenerMontoTotalEntreDosCodigos(a^.HI,codigo1,codigo2) + a^.dato.montoTotal + ObtenerMontoTotalEntreDosCodigos(a^.HD,codigo1,codigo2)
      else begin
